...
_Generado por `npm run audit` el 2026-07-30T01:09:45.570Z._
...
| P2 | 43 | Deuda / limpieza |
| INFO | 35 | Verificado, aceptado o límite de cobertura |
...
| [Anexo D · Consultas del backend vs. esquema real de la base de datos](anexos/04-db-vs-code.md) | 0 | 0 | 2 | 6 |
| [Anexo E · Modelo de autorización: código vs. base de datos](anexos/05-permissions-db-drift.md) | 0 | 0 | 9 | 1 |
...
| AUD-PD003 | permiso-muerto | Permiso que ninguna ruta exige y ninguna vista otorga: config:actualizar | condor.permisos | Confirmar si se valida dentro de algún controller; si no, eliminar el permiso y sus concesiones. |
...
| AUD-PD007 | permiso-muerto | Permiso de visibilidad de una vista que ya no existe: vista:inventario | condor.permisos | Eliminar el permiso y sus concesiones, o registrar la vista si debía existir. |
| AUD-PD008 | permiso-muerto | Permiso que ninguna ruta exige y ninguna vista otorga: inventario:leer | condor.permisos | Confirmar si se valida dentro de algún controller; si no, eliminar el permiso y sus concesiones. |
| AUD-PD009 | permiso-muerto | Permiso que ninguna ruta exige y ninguna vista otorga: requerimientos:entregar | condor.permisos | Confirmar si se valida dentro de algún controller; si no, eliminar el permiso y sus concesiones. |
