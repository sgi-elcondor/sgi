...
const CLASSIC = [
  ...
  "js/views/operacion/mapa-editor.js",
  ...
  "js/views/operacion/inventario.js",
  "js/views/operacion/requerimientos.js",
  "js/views/operacion/aprobaciones.js",
  "js/views/operacion/empresas-aliadas.js",
