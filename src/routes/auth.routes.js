...
const { registrarUsuario, miPerfil, miRol, completarPerfil, actualizarMiPerfil, actualizarAvatar, enviarEmailReset, vincularCuenta, login, verificar2FA, reenviar2FA, solicitarStepUp } = require('../controllers/auth.controller');
...
// SEG-07: step-up code for critical actions performed mid-session (see usuarios.controller.js).
router.post('/step-up/solicitar', verificarToken, rateLimit({ windowMs: 10 * 60 * 1000, max: 15 }), solicitarStepUp);
