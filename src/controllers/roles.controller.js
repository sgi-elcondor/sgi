...
const VISTA_API_MAP = {
  ...
  'ventas':        ['ventas:leer', 'ventas:crear', 'ventas:actualizar', 'ventas:solicitar', 'ventas:editar_financiero', 'lotes:leer', 'compradores:leer', 'comisionistas:leer'],
  ...
  'gastos':        ['gastos:leer', 'gastos:crear', 'gastos:actualizar', 'empresas_aliadas:leer', 'uploads:crear'],
